...
def add_to_watchlist():
    services.add_to_watchlist(int(request.args.get('movie')), session['username'], repo.repo_instance)
    return redirect(url_for('movie_library_bp.watchlist'))

@movie_library_blueprint.route('/remove_from_watchlist', methods=['GET'])
@login_required
def remove_from_watchlist():
    services.remove_from_watchlist(int(request.args.get('movie')), session['username'], repo.repo_instance)
    return redirect(url_for('movie_library_bp.watchlist'))
